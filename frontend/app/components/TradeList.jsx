  ...
  render: function() {
    return (
      <div className="col-md-6">
        <TradeTable flux={this.props.flux} title="Bids" type={1} trades={this.props.trades} tradeList={this.props.trades.tradeBuys} market={this.props.market} user={this.props.user.user} />
      </div>
    );
  }
});
...
var TradeSells = React.createClass({
  render: function() {
    return (
      <div className="col-md-6">
        <TradeTable flux={this.props.flux} title="Asks" type={2} trades={this.props.trades} tradeList={this.props.trades.tradeSells} market={this.props.market} user={this.props.user.user} />
      </div>
    );
  }
});
