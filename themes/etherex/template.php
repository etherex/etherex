...
function etherex_preprocess_page(&$vars) {
  ...
  $vars['head'] = str_replace("\n" . '<link href="//fonts.googleapis.com/css?family=Cinzel:400,700" rel="stylesheet" type="text/css">', "<link href='//fonts.googleapis.com/css?family=Questrial' rel='stylesheet' type='text/css'>", $vars['head']);
