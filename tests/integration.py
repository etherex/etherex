...
class Integration(unittest.TestCase):
    ...
    def test_integration(self):
        ...
        try:
            ...
            self.assertEqual("6.935 thousand", driver.find_element_by_xpath("//div[@id='wrap']/div/div[2]/div[2]/div/div/div").text)
            self.assertEqual("3.065 thousand", driver.find_element_by_xpath("//div[@id='wrap']/div/div[2]/div[2]/div/div[2]/div").text)
