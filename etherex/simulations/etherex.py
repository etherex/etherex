...
class EtherExRun(Simulation):
    ...
    def test_buy_fourth(self):
        tx = Tx(sender='eoar', value=1200 * 10 ** 18, data=[1, 1200 * 10 ** 18, 1000, 1])
        self.run(tx, self.contract)

    def test_buy_fifth(self):
        tx = Tx(sender='fabrezio', value=4200 * 10 ** 18, data=[1, 4000 * 10 ** 18, 1100, 1])
        self.run(tx, self.contract)
    ...
    def test_buy_sixth(self):
        tx = Tx(sender='fabrezio', value=5000 * 10 ** 18, data=[1, 4500 * 10 ** 18, 1100, 1])
        self.run(tx, self.contract)
